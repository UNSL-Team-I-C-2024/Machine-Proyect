...
void CargaTurno(Lista_de_Turnos *ListTurn, Lista_de_Clientes *ListClient); // AA // Finished/ (1)

int BuscarTurnoPorIdcliente (Lista_de_Turnos *Lturno, int IdCliente); // B // Finished/
...
void MuestraAllTurnos (Lista_de_Turnos Lturno); // G // EL ACABADO (6)
